...
- `top_m_SPANET`
    ...
    - Invariant mass of assumed hadronic top quarks, computed from kinematics of b, q1, q2 assigned to targets
- `W_m_SPANET`
    - Type: std::vector[float], Size: 4
    - Invariant mass of assumed hadronic W bosons, computed from kinematics of q1, q2 assigned to targets
- `top_assign_prob_SPANET`
    - Type: std::vector[float], Size: 4
    - Assignment probability for each target (roughly, probability that b_index and q1_index and q2_index are correct - see SPANet documentation)
