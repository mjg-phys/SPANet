...
##
        ...
        plt.savefig( root_file +"_"+branch_name+"_" +whichtop+".pdf") #Save the plot
        plt.show()
...
# root_file = "/hpcfs/groups/phoenix-hpc-coepp/atlas/mjgreen/four-top/run/old_test/wSPANet_v21_v01.root"

# root_file = "/hpcfs/groups/phoenix-hpc-coepp/atlas/mjgreen/four-top/run/03_04_2025/spanet_results_geq_v01.root"
# root_file = "/hpcfs/groups/phoenix-hpc-coepp/atlas/mjgreen/four-top/run/03_04_2025/spanet_results_original_v01.root"
# root_file = "/hpcfs/groups/phoenix-hpc-coepp/atlas/mjgreen/four-top/run/05_01/wSPANet_results.root"


root_file = "/hpcfs/groups/phoenix-hpc-coepp/atlas/mjgreen/four-top/run/05_07_newMatching/wSPANet_results_newMatching_wMET.root"
# root_file = "/hpcfs/groups/phoenix-hpc-coepp/atlas/mjgreen/four-top/run/old_test/wSPANet_good_v01.root"
...
# plot_top_mass(root_file =root_file,branch_name="W_m_SPANET",minPlot = -2, maxPlot = 500e3,whichtop = "leptonic")

# mbl
# plot_top_mass(root_file =root_file,branch_name="mbl_SPANET", minPlot = 0, maxPlot = 400e3,whichtop = "leptonic")

# Assignment Prob
# plot_top_mass(root_file =root_file,branch_name="top_assign_prob_SPANET",whichtop = "hadronic", minPlot = 0, maxPlot = 1)
